...
public class Java8MapAndFlatMapExample
{
    public static void main(String[] args)
    {
        ...
        Set<String> locationsOfInstitutes = instituteList.stream().flatMap(institute ->
                institute.getLocations().stream()).collect(Collectors.toSet());
