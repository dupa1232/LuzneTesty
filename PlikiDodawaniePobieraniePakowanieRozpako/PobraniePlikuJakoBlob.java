...
public class PobraniePlikuJakoBlob {
    ...
    public static void main(String[] args) throws SQLException, IOException {
        ...
        String pathToSzit = "C:\\Users\\User\\Desktop\\zippedSzit23b.zip";
        ...
        //bez tego zamkniecia nie dziala usuwanie pobranego wczesniej zipa
        fis.close();
        bis.close();
        //bez tego zamkniecia nie dziala usuwanie pobranego wczesniej zipa

        //usuniecie pobranego zipa
        File fileToDelete = new File(pathToSzit);
        fileToDelete.delete();
    }
}
